...
INSERT OR IGNORE INTO skills (skill_name) values('sss');
INSERT OR IGNORE INTO status (status_name) values('dada');
SELECT project_id FROM projects WHERE project_name = 'artem' AND user_id = 1;
SELECT skill_id FROM skills WHERE skill_name = 'sss';
INSERT OR IGNORE INTO project_skills VALUES(1, NULL);
SELECT skill_name FROM skills;

SELECT skill_name FROM skills 
JOIN project_skills ON projects.project_id = project_skills.project_id 
JOIN skills ON skills.skill_id = project_skills.skill_id 
WHERE project_name = 'egor'''